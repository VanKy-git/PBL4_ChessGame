...
import com.database.server.DAO.chat_roomDAO.ChatRoomDetails;
import com.database.server.DAO.chat_roomDAO.ChatRoomStatistics;
import com.database.server.Entity.chat_room;
import com.database.server.Service.chat_roomService;
...
public class chat_roomController {
    ...
    public chat_roomController(EntityManagerFactory emf ) {
